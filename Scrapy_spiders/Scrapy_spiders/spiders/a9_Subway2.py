...
class A9SubwaySpider2(scrapy.Spider):
    name = '9_Subway2'
    ...
    custom_settings = {
        ...
        'USER_AGENT': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.3'  # Legitimate User-Agent
    }
