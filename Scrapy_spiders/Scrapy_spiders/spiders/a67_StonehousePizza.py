...
class A67StonehousepizzaSpider(scrapy.Spider):
    name = '67_StonehousePizza'
    allowed_domains = ['www.smartchef.co.uk']
    start_urls = ['https://www.smartchef.co.uk/Brands/stonehouse/']
    ...
    def parse_item(self, response):
        ...
        for item in items:
            ...
            yield {
                ...
                'rest_name': 'Stonehouse Pizza & Carvery',
