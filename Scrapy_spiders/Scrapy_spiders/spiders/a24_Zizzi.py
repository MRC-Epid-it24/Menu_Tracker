...
class A24ZizziSpider(scrapy.Spider):
    ...
    # start_urls = ['https://www.zizzi.co.uk/wp-json/menus/get_menu_from_name?name=3-course-menu-roi']
    ...
    def parse_cat(self, response): 
        ...
        for menu_name in menu_names:
            ...
            #print(f'https://www.zizzi.com/wp-json/menus/get_menu_from_name?name={name}')
            yield scrapy.Request(
                url = f'https://www.zizzi.co.uk/wp-json/menus/get_menu_from_name?name={name}',
