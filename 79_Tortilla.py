...
product_df_all['weight'] = product_df_all['weight'].astype(float)
product_df_all['factor'] = product_df_all['weight']/100
nutrient_cols = ['fat','kcal','salt','carbs','fibre','sugars','protein','saturated_fat']
product_df_all[nutrient_cols] = product_df_all[nutrient_cols].astype(float)
product_df_all[nutrient_cols]= product_df_all[nutrient_cols].multiply(product_df_all.factor, axis=0)
